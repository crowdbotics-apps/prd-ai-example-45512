"""
Django settings for prd_ai_example_45512 project.
...
ROOT_URLCONF = 'prd_ai_example_45512.urls'
...
WSGI_APPLICATION = 'prd_ai_example_45512.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "prd_ai_example_45512 API",
    "DESCRIPTION": "API documentation for prd_ai_example_45512 App",
    "VERSION": "v1",
}
